...
if TYPE_CHECKING:
    from src.custom_types import CameraGroup, Interactables, Player
...
class InteractionHandler:
    ...
    def handle_interaction(self, interactables: Interactables) -> None:
        ...
        # Empty Hand Interaction (Prioritize non-tiles like Plants, NPCs, etc.)
        for target_obj in hit_objects:
            if not isinstance(target_obj, Tile) and target_obj.on_interact(self.player):
